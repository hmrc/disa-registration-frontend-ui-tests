...
object ChangeFcaPlatformNumberPage extends BasePage {
  val pageUrl: String             = s"$baseUrl/change-fca-platform-number"
  val pageTitle: String           =
    "What is the FCA, FRN of PlatformChanged? - ISA products - Manage ISAs - GOV.UK"
